...
def main():
    ...
    # 请确保你在 models/pretrained_weights/ 中放置了对应的 .pth 文件
    ...
    if os.path.exists(pretrained_path):
        ...
        print(f"[警告] 未找到预训练权重 {pretrained_path}，将使用随机初始化权重进行演示。")
    net.to(device)

    # 提取各层特征通道数 (C_out) 供给 RNN 动作空间
